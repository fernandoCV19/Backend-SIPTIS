...
values (1, null, '704-459-0990', 912601, 200547236, 'lastname 1', 'name 1', 1);


INSERT INTO siptis_user_(id_, email_, password_)
VALUES (2, 'estudiante2@gmail.com', '12345678');
insert into user_information_ (id_, birth_date_, cell_number_, ci_, cod_sis_, last_names_, names_, user_id_)
values (2, null, '704-459-0990', 912602, 200547237, 'lastname 2', 'name 2', 2);


INSERT INTO siptis_user_(id_, email_, password_)
VALUES (3, 'tutor1@gmail.com', '12345678');
insert into user_information_ (id_, birth_date_, cell_number_, ci_, cod_sis_, last_names_, names_, user_id_)
values (3, null, '704-459-0990', 912603, 200547237, 'lastname 3', 'name 3', 3);

INSERT INTO siptis_user_(id_, email_, password_)
VALUES (4, 'tutor2@gmail.com', '12345678');
insert into user_information_ (id_, birth_date_, cell_number_, ci_, cod_sis_, last_names_, names_, user_id_)
values (4, null, '704-459-0990', 912604, 200547237, 'lastname 4', 'name 4', 4);


INSERT INTO siptis_user_(id_, email_, password_)
VALUES (5, 'supervisor1@gmail.com', '12345678');
insert into user_information_ (id_, birth_date_, cell_number_, ci_, cod_sis_, last_names_, names_, user_id_)
values (5, null, '704-459-0990', 9125504, 200543237, 'lastname 5', 'name 5', 5);

INSERT INTO siptis_user_(id_, email_, password_)
VALUES (6, 'supervisor2@gmail.com', '12345678');
insert into user_information_ (id_, birth_date_, cell_number_, ci_, cod_sis_, last_names_, names_, user_id_)
values (6, null, '704-459-0990', 9125304, 200247237, 'lastname 6', 'name 6', 6);

INSERT INTO siptis_user_(id_, email_, password_)
VALUES (7, 'docente1@gmail.com', '12345678');
insert into user_information_ (id_, birth_date_, cell_number_, ci_, cod_sis_, last_names_, names_, user_id_)
values (7, null, '704-459-0990', 9112604, 20054707, 'lastname 7', 'name 7', 7);

INSERT INTO siptis_user_(id_, email_, password_)
VALUES (8, 'docente2@gmail.com', '12345678');
insert into user_information_ (id_, birth_date_, cell_number_, ci_, cod_sis_, last_names_, names_, user_id_)
values (8, null, '704-459-0990', 9122604, 2047237, 'lastname 8', 'name 8', 8);
