...
@DataJpaTest
public class ProjectStudentRepositoryTest {
    @Autowired
    ...
    public void givenStudentIdAndProjectId_whenFindByStudentIdAndProjectId_thenProjectStudentObject(){
    ...
    @Sql(scripts = {"/custom_imports/create_projects_and_users.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    public void givenStudentIdAndProjectWrongId_whenFindByStudentIdAndProjectId_thenNull(){
    ...
    @Sql(scripts = {"/custom_imports/create_projects_and_users.sql"}, executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
    public void givenStudentWrongIdAndProjectId_whenFindByStudentIdAndProjectId_thenNull(){
