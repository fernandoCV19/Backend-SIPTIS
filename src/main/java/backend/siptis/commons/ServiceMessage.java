...
public enum ServiceMessage {
    ...
    ERROR_REGISTER_ACCOUNT_CODSIS, ERROR_REGISTER_ACCOUNT_PASSWORD,
    ERROR_INICIO_SESION, ERROR_INICIO_SESION_EMAIL, ERROR_INICIO_SESION_PASSWORD, USER_IS_NOT_A_TRIBUNAL, PROJECT_HAS_ALREADY_A_DEFENSE_DATE, ID_PLACE_DOES_NOT_EXIST, THERE_IS_ANOTHER_RESERVATION_TOO_CLOSE, ID_TRIBUNAL_DOES_NOT_MATCH_WITH_PROJECT, DEFENSE_HAS_NOT_STARTED, DEFENSE_HAS_FINISHED, SCORE_IS_NOT_VALID, THERE_IS_A_PROBLEM_WITH_THE_CLOUD,
