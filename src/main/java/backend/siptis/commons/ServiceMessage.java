...
public enum ServiceMessage {
    ...
    ERROR_INICIO_SESION, ERROR_INICIO_SESION_EMAIL, ERROR_INICIO_SESION_PASSWORD, USER_IS_NOT_A_TRIBUNAL, PROJECT_HAS_ALREADY_A_DEFENSE_DATE, ID_PLACE_DOES_NOT_EXIST, THERE_IS_ANOTHER_RESERVATION_TOO_CLOSE,
}
