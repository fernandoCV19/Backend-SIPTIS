...
public enum ServiceMessage {
    ...
    PROJECT_HAS_ALREADY_A_DEFENSE_DATE, SUCCESSFUL_PROJECT_REGISTER,
    ...
    SEMESTER_STARTED, SEMESTER_ENDED, SEMESTER_INFO_EDITED, NO_CURRENT_SEMESTER, SEMESTER_ALREADY_EXIST,
    SEMESTER_INFORMATION, SEMESTER_ID_NOT_FOUND, ERROR_SEMESTER_DATES,
    ...
    SUB_AREA_NOT_FOUND, SUB_AREA_ALREADY_EXIST, CANNOT_DELETE_SUB_AREA, SUB_AREA_DELETED, SUB_AREA_CREATED, INVALID_SUB_AREA_NAME
    ...
    ERROR_VALIDATION,
    SEMESTER_STARTED, SEMESTER_ENDED, MONTH_NUMBER_NOT_VALID, INVALID_HOUR, INVALID_YEAR, INVALID_DATE, TRIBUNALS_ERROR, DEFENSE_ERROR, SEMESTER_DATE_EDITED
}
